...
$dbname);
  ...
  $sql="SELECT * FROM joat_user WHERE user_uid='$username'";// or email='user_email'");
  ...
  if(mysqli_num_rows($result)>0){
	...
	$sql_2="INSERT into joat_user(app_first, user_uid, user_email, user_pwd, user_type)
...
$stmt->bind_param("sssss", $firstname, $username, $email,$password,$app_type);
