...
<div class="container">
  ...
  <form action="">
    <div class="form-group">
      <label id='lbl_6' for="name">Name:</label>
      <div class="input-group">
      <span class="input-group-addon"><i class="glyphicon glyphicon-user"  title="User"></i></span>
      <input type="text" class="form-control" id="name"  name="name" disabled>
    </div></div>


    <div class="form-group">
      <label id='lbl_3_email' for="email">Email:</label>
      <div class="input-group">
      <span class="input-group-addon"><i class="glyphicon glyphicon-envelope" title="Email"></i></span>
      <input type="email" class="form-control" id="email" placeholder="Enter your email" name="email" disabled>
    </div></div>

    <div class="form-group">
      <label id='lbl_5_contact' for="sel1">Subject (select one):</label>
      <div class="input-group">
      <span class="input-group-addon"data-toggle="tooltip" title="The reason for contacting us">Subject</span>
      <select class="form-control" id="sel1" name="selection">
...
<button type="reset" class="btn btn-default">Reset</buttton>
    </div>
