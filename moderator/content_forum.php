  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="content_news.php">News</a></li>
        <li class="active"><a href="content_forum.php">Form</a></li>
...
<br>
    ...
    <div class="container">
      <h2 id="Joat_head">JOAT Forum</h2>
      <form action="" method="POST">
        <div class="form-group">
          <label id='lbl' for="name">Title:</label>
          <div class="input-group">
          <span class="input-group-addon">Title</span>
          <input type="text" class="form-control" id="name" placeholder="Enter your Forum title" name="name" size="10">
        </div></div>


        <div class="form-group">
          <label id='lbl_5' for="sel1">Forum Type (select one):</label>
          <div class="input-group">
          ...
          <select class="form-control" id="sel1" name='content_type'>
            ...
            <option value ='TSOTW'>Top Stocks of The Week</option>
            <option value ='SOTM'>Stocks of The Month</option>
            <option value ='FR'>Forum rules</option>
          </select>
          <br>
