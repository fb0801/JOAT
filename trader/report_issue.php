...
<form action="create_issue.php" method="POST">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="name" placeholder="Enter your issue title" name="name" size="10">
  </div></div>


  <div class="form-group">
    <label id='lbl_5' for="sel1">Issue Type (select one):</label>
    <div class="input-group">
    ...
    <select class="form-control" id="sel1" name='issue_type'>
      <option value='Account'>Account</option>
      <option value ='Content'>Content</option>
      <option value ='Other'>Other</option>
      <option value ='Card companies'>card companies</option>
  ...
  <div class="form-group">
    <label id='lbl' for="issue text "></label>
    <div class="input-group">
