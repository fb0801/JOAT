  ...
  <a class="edit_link_2" href="invest_create.php"><div class="col-sm-4">
    <div class="well">
      ...
      <p>All your invesments within an ISA tax free</p>
        ...
        <a class="edit_link_2" href="#"><div class="col-sm-4">
          <div class="well">
            <span class="glyc_edit glyphicon glyphicon-exclamation-sign data-toggle="tooltip" title="use at your own risk!""></span>
<h4>Forex</h4>
